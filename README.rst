...
.. _google-cloud-python: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-media-translation


Python Client for Media Translation API
=======================================
...
3. `Enable the Media Translation API.`_
4. `Setup Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Media Translation API.:  https://cloud.google.com/media-translation
...
-  Read the `Client Library Documentation`_ for Media Translation API
   to see other available methods on the client.
-  Read the `Media Translation API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Media Translation API Product documentation:  https://cloud.google.com/media-translation
